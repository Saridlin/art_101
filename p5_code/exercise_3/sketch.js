...
let r1_speedX, r1_speedY, r1_x, r1_y, r1;
let r2_speedX, r2_speedY, r2_x, r2_y, r2;
let r3_speedX, r3_speedY, r3_x, r3_y, r3;
let r4_speedX, r4_speedY, r4_x, r4_y, r4;
...
function draw(){
  ...
  doRoomba(color(237, 163, 59), 'Room-zoom', '', '', r1_x, r1_y, r1_speedX, r1_speedY, 1, r1);
  doRoomba(color(35, 89, 73), 'Zoomer2', 'knife', '', r2_x, r2_y, r2_speedX, r2_speedY, 1, r2);
  doRoomba(color(156, 64, 96), 'Beatrice', '', 'hat', r3_x, r3_y, r3_speedX, r3_speedY, 1, r3);
  doRoomba(color(133, 213, 237), 'Peace', 'hat', 'spoon', r4_x, r4_y, r4_speedX, r4_speedY, 2, r4);
...
function doRoomba(color, name, acc, acc2, lx, ly, sx, sy, s, des){
  ...
  switch(acc){
    ...
    case 'spoon':
      ...
      doAddSpoon();
      pop();
      des = des + " equipped Spoon and";
      break;
    default:
      des = "has nothing on right side and"
  }

  //second set of accessories on opposite
  switch(acc2){
    case 'knife':
      push();
      scale(-1,1);
    ...
    case 'spoon':
      ...
      doAddSpoon();
      pop();
      des = des + " equipped Spoon!";
      break;
    default:
      des = des + " has nothing on left side!";
  }
  ...
  describeElement(name, des, LABEL);
}
